...
})->middleware(['auth', 'checkAccessRole:1,2,3'])->name('applicant');
...
})->middleware(['auth', 'verified', 'checkAccessRole:1,2'])->name('categories');

Route::get('/divisions', function () {
    return view('divisi-management');
})->middleware(['auth', 'checkAccessRole:1,2'])->name('divisions');

Route::get('/opportunities', function () {
    return view('opportunity-management');
})->middleware(['auth', 'checkAccessRole:1,2,3'])->name('opportunities');
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'checkAccessRole:1,2,3'])->group(function () {
...
Route::prefix('admin')->name('admin.')->middleware(['auth', 'checkAccessRole:1'])->group(function () {
