    ...
    <div class="section-body">
        <div class="section-title-lead-wrapper">
            <div class="section-title">
                ...
                <h2 class="section-title-text">Interview HR List</h2>
            </div>
            <p class="section-lead">
                In this section you can manage system Interview HR data such as editing and show detail.
            </p>
        </div>
        @if (session('success'))
                        ...
                        <tbody>
                            @foreach ($applicants as $index => $applicant)
                                <tr>
                                    ...
                                    <td>
                                        @php
                                            $interviewHR = $applicant->InterviewHR ?? null;
                                        @endphp

                                        @if ($interviewHR)
                                            @if ($interviewHR->decision_id != 1)
