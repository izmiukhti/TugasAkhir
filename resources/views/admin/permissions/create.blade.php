    ...
    <div class="section-body">
        <div class="section-title-lead-wrapper">
            <div class="section-title">
                ...
                <h2 class="section-title-text">Create Permission</h2>
            </div>
            <p class="section-lead">In this section you can create new permission to access the system.</p>
        </div>
        @if (session('success'))
                    ...
                    <div class="form-group">
                        ...
                        <div class="d-flex flex-wrap">
                            @foreach ($roles as $role)
                                <div class="form-check form-check-inline me-3 mb-2"> {{-- margin end + margin bottom --}}
