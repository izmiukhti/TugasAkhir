    ...
    <div class="section-body">
        <div class="section-title-lead-wrapper">
            <div class="section-title">
                ...
                <h2 class="section-title-text">Role Detail</h2>
            </div>
            <p class="section-lead">In this section you can show details of the role.</p>
        </div>
        <div class="card-body">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="description" value="{{ $role->description }}" disabled>
            </div>
            <div class="buttons">
