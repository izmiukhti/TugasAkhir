            ...
            <div class="container pt-5">
                <div class="row g-5">
                    ...
                    <div class="col-lg-7 col-md-6 col-sm-12 wow fadeIn" data-wow-delay=".5s">
                        ...
                        <p>SchoolTech Indonesia merupakan sebuah perusahaan yang bergerak pada bidang Information and Technology khususnya memberikan inovasi penerapan Teknologi Informasi dan Komunikasi pada bidang Edukasi.</p>
                        <p class="mb-4">Kami berkomitmen untuk membantu sekolah-sekolah dalam melakukan penerapan teknologi untuk mempermudah proses manajemen sekolah.</p>
                    </div>
                </div>
            </div>
        </div>
